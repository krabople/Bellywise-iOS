...
- Open **Add optional daily context** for that date. Record stress and optional sleep/context. Mark the day finished only after all food, drinks and tracked feelings are logged—including uneventful days. Editing, moving or deleting an entry should reopen affected dates for review.
- Today enters comparisons tomorrow. An explicitly logged food-and-symptom match from an unfinished past day may contribute positive evidence. Unlogged ingredients or symptoms on that day must remain missing; they must never become negative controls. A newly selected feeling must not turn older untracked days into symptom-free days. Unresolved ingredients can exclude a day from comparisons even when marked complete.
